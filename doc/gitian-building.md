...
To build Philscurrency (for Linux, OS X and Windows) just follow the steps under 'perform
...
For example:
```bash
URL=https://github.com/user/philscurrency.git
...
[philscurrency/gitian.sigs](https://github.com/philscurrency/gitian.sigs.phils/) repository, or if that's not possible create a pull
request. 
