...
Only requiring some minor changes is philscurrency.cpp.
...
Changes to philscurrency.cpp
----------------------
philscurrency.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
