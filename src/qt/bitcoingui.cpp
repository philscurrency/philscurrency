    ...
    spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Philscurrency Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle *networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Philscurrency address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and philscurrency: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Philscurrency Core"), this);
    aboutAction->setStatusTip(tr("Show information about Philscurrency Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Philscurrency"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Philscurrency addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Philscurrency addresses"));
    ...
    openAction->setStatusTip(tr("Open a philscurrency: URI or payment request"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Philscurrency Core help message to get a list with possible Philscurrency command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Philscurrency Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Philscurrency network", "", count));
}
...
{
    QString strTitle = tr("Philscurrency Core"); // default title
