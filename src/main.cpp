...
#if defined(NDEBUG)
# error "Philscurrency cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Philscurrency Signed Message:\n";
...
void ThreadScriptCheck() {
    RenameThread("philscurrency-scriptch");
...
bool ContextualCheckBlockHeader(const CBlockHeader& block, CValidationState& state, CBlockIndex * const pindexPrev)
{
    ...
    // Philscurrency: Reject block.nVersion=1 blocks (mainnet >= 710000, testnet & regtest uses supermajority)
...
bool ContextualCheckBlock(const CBlock& block, CValidationState& state, CBlockIndex * const pindexPrev)
{
    ...
    // Philscurrency: (mainnet >= 710000, testnet >= 400000, regtest uses supermajority)
