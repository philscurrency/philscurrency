...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Philscurrency Core philscurrency-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  philscurrency-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded philscurrency transaction") + "\n" +
              "  philscurrency-tx [options] -create [commands]   " + _("Create hex-encoded philscurrency transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded philscurrency transaction
