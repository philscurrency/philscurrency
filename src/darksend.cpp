...
/* *** BEGIN DARKSEND MAGIC - DASH **********
    Copyright (c) 2014-2015, The Dash Developers
        eduffield - evan@philscurrency.com
        udjinm6   - udjinm6@philscurrency.com
*/
    ...
    if(fMasterNode) {
        ...
        BOOST_FOREACH(const CTransaction& txCollateral, vecSessionCollateral) {
            ...
            /*
                ...
                allow endless transaction that would bloat Philscurrency and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("philscurrency-darksend");
