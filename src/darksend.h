...
{
public:
    /// Is the inputs associated with this public key? (and there is 12000 PHILS - checking if valid masternode)
...
public:
    ...
    /// Get the denominations for a specific amount of philscurrency.
